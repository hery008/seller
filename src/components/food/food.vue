            ...
            <div class="food-content">
                ...
                <div class="content">
                    ...
                    <div class="detil">
                        ...
                        <span class="rating">好拼率:{{food.rating}}</span>
                    </div>
                    <div class="price">
               ...
               <div class="rating">
                   ...
                   <ratingselect @type = "type" @content = "content" :select-type = "selectType" :only-content = "onlyContent" :desc = "desc" :ratings = "food.ratings"></ratingselect> 
